            ...
            <div class="booking_table d_flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						...
						<a href="signin.php" class="btn theme_btn button_hover">Sign in</a>
					</div>
				</div>
            </div>
                        ...
                        <div class="col-md-9">
                            <div class="boking_table">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="book_tabel_item"> 
                                            <a class="book_now_btn button_hover" href="rooms.php">Room Book Now</a><br>
											<a class="book_now_btn button_hover" href="rooms.php">Hall Book Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="facilities_area section_gap">
            ...
            <div class="container">
                ...
                <div class="row mb_30">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="facilities_item">
                            <h4 class="sec_h4"><i class="lnr lnr-coffee-hall"></i>Hall Decoration</h4>
                            <p>Usage of the Internet is becoming more common due to rapid advancement of technology and power.</p>
                        </div>
                    </div>
                </div>
